...
const items: { key: RouteKey; label: string; description: string; roles?: string[] }[] = [
  ...
  { key: 'quotations', label: 'Quotations', description: 'Compare vendor offers', roles: ['admin', 'officer', 'procurement_head', 'vendor'] },
  ...
  { key: 'invoices', label: 'Invoices', description: 'Billing and due dates', roles: ['admin', 'officer', 'procurement_head', 'vendor', 'finance_manager'] },
